VERSION 5.00
Begin VB.Form frmStaMultiAccount 
   Caption         =   "Add values"
   ClientHeight    =   7815
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.Frame fraLists 
      ...
      Begin VB.ListBox lstCode 
         Height          =   1815
         Index           =   1
         ItemData        =   "stcmuacct.frx":0000
         Left            =   120
         List            =   "stcmuacct.frx":0007
         TabIndex        =   18
         Top             =   600
         Width           =   1455
      End
   ...
   Begin VB.Frame fraLists 
      ...
      Begin VB.ListBox lstCode 
         Height          =   1815
         Index           =   0
         ItemData        =   "stcmuacct.frx":0017
         Left            =   120
         List            =   "stcmuacct.frx":001E
         TabIndex        =   8
         Top             =   600
         Width           =   1455
      End
   ...
   End
End
Attribute VB_Name = "frmStaMultiAccount"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Const lintStartIndex = 0
Const lintEndIndex = 1
...
Dim lintArrInc As Integer
    ...
    Case gconstrConfigRoute
        ...
        Unload Me
        frmStaMultiOrder.FinalForm = mfrmFinalForm
        frmStaMultiOrder.CallingForm = Me
        frmStaMultiOrder.Route = gconstrConfigRoute
        Me.Enabled = True
        frmStaMultiOrder.Show
    End Select
