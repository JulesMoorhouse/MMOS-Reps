VERSION 5.00
Begin VB.Form frmStaMultiOrder 
   Caption         =   "Add values"
   ClientHeight    =   7815
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.Frame fraLists 
      ...
      Begin VB.ListBox lstCode 
         Height          =   1815
         Index           =   1
         ItemData        =   "stcmuordr.frx":0000
         Left            =   120
         List            =   "stcmuordr.frx":0007
         TabIndex        =   18
         Top             =   600
         Width           =   1455
      End
   ...
   Begin VB.Frame fraLists 
      ...
      Begin VB.ListBox lstCode 
         Height          =   1815
         Index           =   0
         ItemData        =   "stcmuordr.frx":0017
         Left            =   120
         List            =   "stcmuordr.frx":001E
         TabIndex        =   6
         Top             =   600
         Width           =   1455
      End
   ...
   End
End
Attribute VB_Name = "frmStaMultiOrder"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Const lintStartIndex = 2
Const lintEndIndex = 3
...
Dim lintArrInc As Integer
    ...
    Case gconstrConfigRoute
        ...
        Unload Me
        frmStaMultiMarket.NextForm = frmStaMultiConsignment
        frmStaMultiMarket.FinalForm = mfrmFinalForm
        frmStaMultiMarket.CallingForm = Me
        frmStaMultiMarket.Route = gconstrConfigRoute
        Me.Enabled = True
