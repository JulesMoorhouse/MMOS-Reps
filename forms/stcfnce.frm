VERSION 5.00
Begin VB.Form frmStaticFinance 
   ...
   End
End
Attribute VB_Name = "frmStaticFinance"
...
Dim lintArrInc As Integer
    ...
    Case gconstrConfigRoute
        ...
        Unload Me
        frmStaticCompany.FinalForm = mfrmFinalForm
        frmStaticCompany.CallingForm = Me
        frmStaticCompany.Route = gconstrConfigRoute
        Me.Enabled = True
        frmStaticCompany.Show
...
Dim lintArrInc As Integer
    ...
    lintStartIndex = gconintStaticFinanceVAT
    lintEndIndex = gconintStaticFinanceCSLn2
